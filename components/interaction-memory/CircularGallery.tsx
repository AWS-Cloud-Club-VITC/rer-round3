...
class App {
  ...
  createMedias(items: any[], bend = 1, textColor: string, borderRadius: number, font: string) {
    const defaultItems = [
      { image: `https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?w=800&fit=crop`, text: "Singapore" },
      { image: `https://images.unsplash.com/photo-1519501025264-65ba15a82390?w=800&fit=crop`, text: "Copenhagen" },
      { image: `https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800&fit=crop`, text: "Tokyo" },
      { image: `https://images.unsplash.com/photo-1486325212027-8081e485255e?w=800&fit=crop`, text: "Medellín" },
      { image: `https://images.unsplash.com/photo-1444723121867-7a241cacace9?w=800&fit=crop`, text: "Amsterdam" },
      { image: `https://images.unsplash.com/photo-1471922694854-ff1b63b20054?w=800&fit=crop`, text: "Curitiba" },
    ];
